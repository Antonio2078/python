...
mydb = mysql.connector.connect(host ="localhost", user ="root", password ="", database = "bd_traductor_python")
...
while palabra != 0:
    ...
    if len(resultado) > 0:
        ...
        print("Esta palabra no existe. Desea agregarla al diccionario?")
        resp = input("S / N ")
        if (resp in ["S","s"]):
